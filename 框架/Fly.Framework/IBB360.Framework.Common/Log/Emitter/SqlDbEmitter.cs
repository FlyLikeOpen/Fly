...
namespace Fly.Framework.Common
{
    internal class SqlDbEmitter : ILogEmitter
    {
        ...
        private ConnectionStringConfigType m_ConnectionStringConfigType = ConnectionStringConfigType.AppConfig;
        ...
        private void InsertLog(LogEntry log, string connStr, string sql, string dbProviderName)
        {
                ...
                TransactionScopeConnections.GetOpenConnection(connStr, () => { return CreateDbConnection(dbProviderName); }))
            {
                ...
                List<DbParameter> pList = new List<DbParameter>()
                {
                    ...
                    CreateDbParameter(dbProviderName, "@RequestReferer", log.RequestReferer, DbType.AnsiString),    // 5
                    CreateDbParameter(dbProviderName, "@ServerName", log.ServerName, DbType.AnsiString),    // 6
                    CreateDbParameter(dbProviderName, "@ServerTime", log.ServerTime, DbType.DateTime),    // 7
                    CreateDbParameter(dbProviderName, "@ServerIP", log.ServerIP, DbType.AnsiString),    // 8
                    CreateDbParameter(dbProviderName, "@ReferenceKey", log.ReferenceKey, DbType.String),    // 9
                    CreateDbParameter(dbProviderName, "@UserHostName", log.UserHostName, DbType.String),    // 10
                    CreateDbParameter(dbProviderName, "@UserHostAddress", log.UserHostAddress, DbType.String),  // 11
                    CreateDbParameter(dbProviderName, "@Content", log.Content, DbType.String),  // 12
                    CreateDbParameter(dbProviderName, "@ProcessID", log.ProcessID, DbType.Int32),  // 13
                    CreateDbParameter(dbProviderName, "@ProcessName", log.ProcessName, DbType.String),  // 14
                    CreateDbParameter(dbProviderName, "@ThreadID", log.ThreadID, DbType.Int32), // 15
                    CreateDbParameter(dbProviderName, "@ExtendedProperties", pro, DbType.String),    // 16
                    CreateDbParameter(dbProviderName, "@OperatorUser", log.OperatorUser, DbType.String),    // 17
                    CreateDbParameter(dbProviderName, "@StackTrace", log.StackTrace, DbType.String)    // 18
                };
        ...
        private class ConnStringMgr
        {
            ...
            public static string GetConnectionString(string name, bool needDecrypt = true, ConnectionStringConfigType configType = ConnectionStringConfigType.AppConfig)
            {
                string dbType;
                return GetConnectionString(name, out dbType, needDecrypt, configType);
            }

            public static string GetConnectionString(string name, out string dbType, bool needDecrypt = true, ConnectionStringConfigType configType = ConnectionStringConfigType.AppConfig)
            {
