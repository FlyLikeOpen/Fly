...
{
    [Serializable]
    public class DaoSqlException : ApplicationException
    {
        public DaoSqlException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }

        public DaoSqlException(Exception innerException, string connectionStr, string sqlText,
